...
function SectionNum({ n }: { n: string }) {
  return (
    <p className="text-[11px] font-mono uppercase tracking-[0.22em] text-blue-500/60 mb-2 select-none">
      {n}
    </p>
  )
}
      ...
      <article className="pb-16 md:pb-24">
        ...
        <header className="w-full max-w-6xl mx-auto px-4 md:px-8 pt-10 mb-14 md:mb-18">
          <AnimatedDiv delay={0.05}>
            <p className="text-[11px] font-mono font-semibold tracking-[0.28em] uppercase text-blue-600 mb-4">
          ...
          <AnimatedDiv delay={0.2}>
            <dl className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm">
              {[
                ...
                <div key={label} className="flex flex-col p-3 rounded-xl bg-slate-50 ring-1 ring-slate-200">
                  <dt className="text-[10px] uppercase tracking-widest font-semibold text-blue-600 mb-1.5">{label}</dt>
        ...
        <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 flex gap-12 lg:gap-16">
          ...
          <div className="min-w-0 flex-1 max-w-6xl space-y-16 md:space-y-20">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <AnimatedDiv key={i} delay={0.05 * i}>
                    <div className="flex items-start gap-3 p-4 rounded-xl bg-white ring-1 ring-slate-200 shadow-sm">
                      <span className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-50 text-blue-600 text-[11px] font-bold flex items-center justify-center mt-0.5 tabular-nums ring-1 ring-blue-200">
                        {i + 1}
                      </span>
            ...
            <section id={TOC_SECTIONS[1].id}>
              ...
              <AnimatedDiv delay={0.1}>
                <div className="rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm p-6 md:p-8">
                  ...
                  <div className="mt-5 pt-5 border-t border-slate-200 flex flex-wrap gap-3">
                    {[
                      ...
                      <div
                        key={label}
                        className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl ring-1 text-sm font-medium bg-blue-50 ring-blue-200 text-slate-800"
                      >
            ...
            <section id={TOC_SECTIONS[3].id}>
              ...
              <AnimatedDiv delay={0.1}>
                <div className="relative rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 overflow-hidden p-10 md:p-14">
                  <div
                    className="absolute inset-0 pointer-events-none"
                    aria-hidden
                    style={{
                      background:
                        'radial-gradient(ellipse 70% 80% at 50% 50%, rgba(255,255,255,0.1), transparent)',
                    }}
                  />
                  ...
                  <div className="relative z-10 space-y-3">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-3">
                        <span className="flex-shrink-0 w-6 h-6 rounded-full bg-white/15 text-white/90 text-[11px] font-bold flex items-center justify-center mt-0.5 tabular-nums">
                          {i + 1}
                        </span>
            ...
            <section id={TOC_SECTIONS[4].id}>
              ...
              <AnimatedDiv delay={0.05}>
                <blockquote className="relative my-6 rounded-2xl bg-slate-900 overflow-hidden px-8 py-8 md:px-10 md:py-10">
                  <span
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <AnimatedDiv key={i} delay={0.1 + i * 0.1}>
                    <div className="relative rounded-xl bg-white shadow-md ring-1 ring-slate-200 p-5 h-full">
                      <span
                        className="absolute font-serif text-blue-100 select-none pointer-events-none"
                        aria-hidden
                        style={{ fontSize: '80px', lineHeight: 1, top: '-8px', left: '8px' }}
                      >
                        &ldquo;
                      </span>
                      <p className="relative text-slate-700 font-medium italic text-sm leading-relaxed z-10">
                        &ldquo;{quote}&rdquo;
                      </p>
                    </div>
                  </AnimatedDiv>
              ...
              <p className="text-slate-600 leading-relaxed mt-6 text-base">
                      ...
                      <div className="flex flex-wrap justify-center gap-4 md:gap-6 max-w-[1400px] mx-auto">
                        {[
                          ...
                          <div key={label} className="group flex flex-col items-center">
                            ...
                            <p className="text-slate-400 text-xs md:text-sm italic text-center">
                              {label}
                            </p>
                          </div>
                        ))}
            ...
            <section id={TOC_SECTIONS[6].id}>
              ...
              <AnimatedDiv delay={0.05}>
                <blockquote className="relative rounded-2xl bg-slate-900 overflow-hidden px-8 py-8 md:px-10 md:py-10 mb-8">
                  <span
                    className="absolute font-serif text-white/10 select-none pointer-events-none"
                    aria-hidden
                    style={{ fontSize: '160px', lineHeight: 1, top: '-20px', left: '12px' }}
